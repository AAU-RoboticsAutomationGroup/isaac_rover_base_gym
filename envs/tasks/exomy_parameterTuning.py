...
class Exomy_parameterTuning(VecTask):
    ...
    def reset_idx(self, env_ids):
        ...
        dist_buf = torch.where(((target_distance > 0.1) | (self.root_positions[env_ids, 0] >= self.terrain_width_total) | (self.root_positions[env_ids, 2] < -1.0)), 1, 0)
